                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="page-title mb-0 font-size-18"> Onboarding </h4>

                <button class="btn btn-light" >
  <a href="add-onboarding.php">Add</a>
</button>
                    ...
                    <div class="col-12"> 
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php
    $qury = ( "SELECT * FROM onboarding where hide = 0 ");
...
?>
        ...
        echo "  <td > {$pro_namear} </td> " ;
         echo "<td><img src='images/onboarding/{$pro_image}' alt='image' width='100' height='70'></td>";
         echo "  <td > {$pro_detail} </td> " ;
         echo "  <td > {$pro_detail_ar} </td> " ;
        echo " <td >  $pro_date  </td>";   
...
<?php 
  ...
  if(isset($_GET['delete'])){
    $pro = $_GET['delete'];
    $query = " DELETE FROM onboarding where id = {$pro}  ";
