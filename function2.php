...
function user(){ ?>
    <div class="user-wid text-center py-4">
            ...
            <div class="mt-3">
                ...
                <a href="#" class="text-reset fw-medium font-size-16"><?php echo $_SESSION['username'];?></a>
...
<ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="subcategory.php" class="has-arrow waves-effect">
                        <i class="mdi mdi-inbox-full"></i>
                        <span>Subactegory</span>
                    </a>
                ...
                <li>
                    <a href="onboarding.php" class="has-arrow waves-effect">
